...
class AgentActivity:
    ...
    def to_episode_text(self) -> str:
        ...
        Uses natural language description so Zep can extract entities and relationships
        Does not add simulation prefixes to avoid misleading graph updates
        """
    ...
    def _describe_quote_post(self) -> str:
        """Quote post - includes original post, author info, and quote comment"""
        original_content = self.action_args.get("original_content", "")
        original_author = self.action_args.get("original_author_name", "")
...
class ZepGraphMemoryUpdater:
    ...
    Groups by platform, batches to Zep after accumulating BATCH_SIZE activities.
    ...
    def __init__(self, graph_id: str, api_key: Optional[str] = None):
        ...
        # Platform-grouped activity buffer (each platform batches to BATCH_SIZE before sending)
        ...
        self._total_items_sent = 0  # Successful activities sent to Zep
    ...
    def add_activity(self, activity: AgentActivity):
        ...
        action_args contains complete context information (e.g., post content, username, etc.).
    ...
    def _flush_remaining(self):
        ...
        # First process remaining queue activities into buffer
