...
class SimulationRunner:
    ...
    4. Supporting pause/stop/resume actions
    """
    ...
    def start_simulation(
        ...
        try:
            ...
            # Create main log file to avoid stdout/stderr pipe buffer full blocking process
    ...
    def cleanup_simulation_logs(cls, simulation_id: str) -> Dict[str, Any]:
        ...
        logger.info(f"Simulation log cleanup completed: {simulation_id}, DeleteFile: {cleaned_files}")
    ...
    def register_cleanup(cls):
        ...
        Called after Flask app starts, ensures all simulation processes are cleaned up on server shutdown
        """
        ...
        # If not debug mode, this env var doesn't exist, registration is also needed
    ...
    def check_env_alive(cls, simulation_id: str) -> bool:
        ...
        Returns:
            True means environment is alive, False means environment has closed
        """
        sim_dir = os.path.join(cls.RUN_STATE_DIR, simulation_id)
        if not os.path.exists(sim_dir):
            return False
    ...
    def interview_agents_batch(
        ...
        Args:
            ...
            platform: Default platform (optional，overridden by each interview item platform）
                - "twitter": Default to Twitter platform interview only
                - "reddit": Default to Reddit platform interview only
