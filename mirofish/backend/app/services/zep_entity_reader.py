...
class ZepEntityReader:
    ...
    def filter_defined_entities(
        ...
        Filter logic:
        - If node Labels only contain "Entity", the entity does not match predefined types, skip
        - If node Labels contain labels other than "Entity" and "Node", it matches predefined types, keep
        
        Args:
            graph_id: Graph ID
            defined_entity_types: Predefined entity type list (optional, keeps only these types if provided)
