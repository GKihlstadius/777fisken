...
- Government departments, regulatory institutions
...
A. **Fallback types (must be included, placed as the last 2 in the list)**:
   ...
   - `Organization`: Fallback type for any organization/institution. When an organization does not belong to any more specific organization type, classify it here.
...
- GovernmentAgency: Government institution
...
class OntologyGenerator:
    ...
    # Maximum text length sent to LLM (50k chars)
