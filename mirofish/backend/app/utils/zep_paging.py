...
This module wraps automatic page-turning logic (with per-page retry) and transparently returns complete lists.
"""
...
def fetch_all_edges(
    ...
    """Fetch all graph edges with pagination, returning complete list. Each page request has built-in retry."""
    all_edges: list[Any] = []
    cursor: str | None = None
    page_num = 0
