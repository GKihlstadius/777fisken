...
```env
# Primary LLM — Groq (free, fast inference)
...
# Fallback LLM — OpenRouter (used when Groq rate limits are hit)
...
# Zep Cloud Configuration (free tier sufficient for basic usage)
# Sign up at: https://app.getzep.com/
ZEP_API_KEY=your_zep_api_key
```

> **Note:** You can also use the legacy `LLM_API_KEY` / `LLM_BASE_URL` / `LLM_MODEL_NAME` format with any OpenAI-compatible API.
