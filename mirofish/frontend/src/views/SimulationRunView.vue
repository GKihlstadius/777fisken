<template>
  <div class="main-view">
    ...
    <header class="app-header">
      ...
      <div class="header-right">
        <div class="workflow-step">
          ...
          <span class="step-name">Begin Simulation</span>
        </div>
    ...
    <main class="content-area">
      ...
      <!-- Right Panel: Step3 Begin Simulation -->
...
// Get maxRounds from query params at init time, ensuring child component gets it immediately
...
const loadGraph = async (graphId) => {
  // When simulating, auto-refresh without full-screen loading to avoid flicker
