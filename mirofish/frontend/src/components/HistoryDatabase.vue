  ...
  >
    ...
    <div v-if="projects.length > 0" class="cards-container" :class="{ expanded: isExpanded }" :style="containerStyle">
      ...
      >
        ...
        <!-- Bottom decorative line (expand on hover) -->
        ...
        <div v-if="selectedProject" class="modal-overlay" @click.self="closeModal">
          <div class="modal-content">
            ...
            <div class="modal-playback-hint">
              <span class="hint-text">Step 3 "Begin Simulation" and Step 5 "Deep Interaction" must be started during runtime and do not support historical replay</span>
            </div>
          </div>
        </div>
      </Transition>
...
const getCardStyle = (index) => {
  ...
  if (isExpanded.value) {
    ...
    const x = offset * 35
    // Adjust starting position, close to title with proper spacing
  ...
  observer = new IntersectionObserver(
    (entries) => {
      entries.forEach((entry) => {
        ...
        // Use debounce delay for state switch to prevent rapid flicker
    ...
    },
    {
      ...
      // Adjust rootMargin, shrink viewport bottom to require more scroll to trigger expansion
...
.grid-pattern {
  ...
  /* Position from top-left, only expand at bottom on height change */
...
.cards-container {
  ...
  /* min-height dynamically computed by JS, auto-adjusting based on card count */
}
