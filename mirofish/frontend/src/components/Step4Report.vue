...
const parseInsightForge = (text) => {
  ...
  try {
    ...
    // Extract statistics - Match format like 'relevant prediction facts: X items'
    ...
    // Extract relationship chains - Full extraction, no quantity limit
...
const parsePanorama = (text) => {
  ...
  try {
    ...
    // 提取当前有效事实 - Full extraction, no quantity limit
    ...
    // 提取历史/过期事实 - Full extraction, no quantity limit
    ...
    // Extract involved entities - Full extraction, no quantity limit
    ...
    const parseIndividualReasons = (reasonText) => {
      ...
      for (const line of lines) {
        ...
        if (name) {
          ...
          // Reason continuation (exclude ending summary paragraphs)
...
const parseQuickSearch = (text) => {
  ...
  try {
    ...
    // 提取相关事实 - Full extraction, no quantity limit
