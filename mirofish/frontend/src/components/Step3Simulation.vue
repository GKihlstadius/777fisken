...
// Track previous round for each platform, for change detection and logging
...
const fetchRunStatus = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Extra check: if backend hasn't updated runner_status yet but platforms reported complete
      // Determined via twitter_completed and reddit_completed status
